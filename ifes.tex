...
%\include{outros/ficha}
\includepdf[pages=-]{outros/ficha-biblioteca.pdf}
%\include{outros/aprovacao}
\includepdf[pages=-]{outros/folha-aprovacao.pdf}
\include{outros/declaracaoautor}
\include{outros/dedicatoria}
\include{outros/agradecimento}
\include{outros/epigrafe}
\include{outros/resumo}
\include{outros/abstract}
